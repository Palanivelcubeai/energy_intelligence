...
interface CarbonMetrics {
  totalCO2Today: number; totalCO2Month: number; carbonIntensity: number;
  renewablePercent: number; carbonSaved: number; sustainabilityScore: number;
}
interface CO2Trend { date: string; co2: number; kwh: number; intensity: number; parts: number }
interface CO2Machine { name: string; co2: number; kwh: number }
